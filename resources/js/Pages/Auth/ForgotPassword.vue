        ...
        <div class="w-px-400 mx-auto">
            ...
            <form id="formAuthentication" class="mb-3" @submit.prevent="submit">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="email" v-model="form.email" placeholder="johndoe@gmail.com"
            ...
            <div class="text-center">
                <Link :href="route('index')" class="d-flex align-items-center justify-content-center">
